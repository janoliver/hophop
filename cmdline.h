...
/** @brief Where the command line options are stored */
    struct gengetopt_args_info
    {
        ...
        const char *cutoutenergy_help;
                                 /**< @brief States below this energy will be cut out of the DOS help description.  */
        ...
        const char *cutoutwidth_help;
                                /**< @brief The width of energies who are cutted. help description.  */
        int ncarriers_arg;
        ...
        int meanfield_flag;
                        /**< @brief Instead of simulating n carriers, use a single carrier in a modified DOS (mean field approach) (default=off).  */
        const char *meanfield_help;
                              /**< @brief Instead of simulating n carriers, use a single carrier in a modified DOS (mean field approach) help description.  */
        int be_flag;
        ...
        unsigned int meanfield_given;   /**< @brief Whether meanfield was given.  */
