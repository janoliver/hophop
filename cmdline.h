...
/** @brief Where the command line options are stored */
    struct gengetopt_args_info
    {
        ...
        char *sigma_orig;
                        /**< @brief The width of the DOS specified with --exponent. original value given at command line.  */
        const char *sigma_help;
                          /**< @brief The width of the DOS specified with --exponent. help description.  */
        float exponent_arg;
                        /**< @brief The exponent of the DOS g(x) = exp(-(x/sigma)^p) (default='2.0').  */
        char *exponent_orig;
                        /**< @brief The exponent of the DOS g(x) = exp(-(x/sigma)^p) original value given at command line.  */
        const char *exponent_help;
                             /**< @brief The exponent of the DOS g(x) = exp(-(x/sigma)^p) help description.  */
        float llength_arg;
        ...
        int gaussian_flag;
                        /**< @brief Use a Gaussian DOS with std. dev. sigma. g(x) = exp(-1/2*(x/sigma)^2) (default=off).  */
        const char *gaussian_help;
                             /**< @brief Use a Gaussian DOS with std. dev. sigma. g(x) = exp(-1/2*(x/sigma)^2) help description.  */
        int lattice_flag;
        ...
        int ar_flag;
                /**< @brief Use Walker's random number generation and the accept/reject technique for finding the next transition. This is efficient for high concentrations around n=N/2 (default=off).  */
        const char *ar_help;
                       /**< @brief Use Walker's random number generation and the accept/reject technique for finding the next transition. This is efficient for high concentrations around n=N/2 help description.  */
        long simulation_arg;
        ...
        char *be_it_orig;
                        /**< @brief Max inner iterations after which the calculation is stopped. If 0 is specified, the default is Number of sites - 1 original value given at command line.  */
        const char *be_it_help;
                          /**< @brief Max inner iterations after which the calculation is stopped. If 0 is specified, the default is Number of sites - 1 help description.  */
        ...
        unsigned int sigma_given;
                                /**< @brief Whether sigma was given.  */
