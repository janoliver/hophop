 ...
 * gengetopt --conf-parser --set-version=1.2 --set-package=hop --show-required -l -i options.ggo 
 * 
                         ...
                         const char *additional_error)
{
    ...
    while (1)
    {
        ...
        c = getopt_long (argc, argv,
                         "hVl:X:Y:Z:n:N:s:p:a:r:F:T:I:R:i:Pqo:y:c:f:m",
        ...
        case 'r':              /* Determines up to which distance sites should be neighbors..  */
            ...
            if (update_arg ((void *) &(args_info->rc_arg),
                            ...
                            ARG_FLOAT, check_ambiguity, override, 0, 0, "rc",
                            'r', additional_error))
                goto failure;
