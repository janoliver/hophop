 ...
 * gengetopt --conf-parser --set-version=2.0 --set-package=HOP --show-required -l -i options.ggo 
 * 
...
const char *gengetopt_args_info_help[] = {
    ...
    "      --meanfield               Instead of simulating n carriers, use a single \n                                  carrier in a modified DOS (mean field \n                                  approach)  (default=off)",
    "\nBalance equations:",
...
typedef enum
{ ARG_NO, ARG_FLAG, ARG_STRING, ARG_INT, ARG_LONG, ARG_FLOAT
...
clear_given (struct gengetopt_args_info *args_info)
{
    ...
    args_info->cutoutenergy_given = 0;
    args_info->cutoutwidth_given = 0;
    args_info->ncarriers_given = 0;
    args_info->simulation_given = 0;
    args_info->relaxation_given = 0;
    args_info->nreruns_given = 0;
    args_info->meanfield_given = 0;
...
clear_args (struct gengetopt_args_info *args_info)
{
    ...
    args_info->cutoutenergy_arg = 0;
    args_info->cutoutenergy_orig = NULL;
    args_info->cutoutwidth_arg = 0.5;
    args_info->cutoutwidth_orig = NULL;
    ...
    args_info->nreruns_arg = 1;
    args_info->nreruns_orig = NULL;
    args_info->meanfield_flag = 0;
    args_info->be_flag = 0;
    args_info->be_it_arg = 1000;
...
init_args_info (struct gengetopt_args_info *args_info)
{
    ...
    args_info->field_help = gengetopt_args_info_help[11];
    args_info->temperature_help = gengetopt_args_info_help[12];
    args_info->length_help = gengetopt_args_info_help[15];
    args_info->X_help = gengetopt_args_info_help[16];
    args_info->Y_help = gengetopt_args_info_help[17];
    args_info->Z_help = gengetopt_args_info_help[18];
    args_info->nsites_help = gengetopt_args_info_help[19];
    args_info->rc_help = gengetopt_args_info_help[20];
    args_info->exponent_help = gengetopt_args_info_help[21];
    args_info->llength_help = gengetopt_args_info_help[22];
    args_info->gaussian_help = gengetopt_args_info_help[23];
    args_info->lattice_help = gengetopt_args_info_help[24];
    args_info->removesoftpairs_help = gengetopt_args_info_help[25];
    args_info->softpairthreshold_help = gengetopt_args_info_help[26];
    args_info->cutoutenergy_help = gengetopt_args_info_help[27];
    args_info->cutoutwidth_help = gengetopt_args_info_help[28];
    args_info->ncarriers_help = gengetopt_args_info_help[31];
    args_info->simulation_help = gengetopt_args_info_help[32];
    args_info->relaxation_help = gengetopt_args_info_help[33];
    args_info->nreruns_help = gengetopt_args_info_help[34];
    args_info->meanfield_help = gengetopt_args_info_help[35];
    args_info->be_help = gengetopt_args_info_help[38];
    args_info->be_it_help = gengetopt_args_info_help[39];
    args_info->be_oit_help = gengetopt_args_info_help[40];
    args_info->tol_abs_help = gengetopt_args_info_help[41];
    args_info->tol_rel_help = gengetopt_args_info_help[42];
    args_info->an_help = gengetopt_args_info_help[45];
    args_info->percolation_threshold_help = gengetopt_args_info_help[46];
    args_info->outputfolder_help = gengetopt_args_info_help[48];
    args_info->transitions_help = gengetopt_args_info_help[49];
    args_info->summary_help = gengetopt_args_info_help[50];
    args_info->comment_help = gengetopt_args_info_help[51];
...
cmdline_parser_release (struct gengetopt_args_info *args_info)
{
    ...
    free_string_field (&(args_info->cutoutenergy_orig));
    free_string_field (&(args_info->cutoutwidth_orig));
    ...
    free_string_field (&(args_info->nreruns_orig));
    ...
    free_string_field (&(args_info->percolation_threshold_orig));
...
cmdline_parser_dump (FILE * outfile, struct gengetopt_args_info *args_info)
{
    ...
    if (args_info->temperature_given)
        write_into_file (outfile, "temperature", args_info->temperature_orig,
                         0);
    ...
    if (args_info->softpairthreshold_given)
        write_into_file (outfile, "softpairthreshold",
                         args_info->softpairthreshold_orig, 0);
    if (args_info->cutoutenergy_given)
        write_into_file (outfile, "cutoutenergy", args_info->cutoutenergy_orig,
                         0);
    if (args_info->cutoutwidth_given)
        write_into_file (outfile, "cutoutwidth", args_info->cutoutwidth_orig,
                         0);
    ...
    if (args_info->nreruns_given)
        write_into_file (outfile, "nreruns", args_info->nreruns_orig, 0);
    if (args_info->meanfield_given)
        write_into_file (outfile, "meanfield", 0, 0);
    ...
    if (args_info->percolation_threshold_given)
        write_into_file (outfile, "percolation_threshold",
                         args_info->percolation_threshold_orig, 0);
    if (args_info->outputfolder_given)
        write_into_file (outfile, "outputfolder", args_info->outputfolder_orig,
                         0);
                         ...
                         const char *additional_error)
{
    ...
    while (1)
    {
        ...
        static struct option long_options[] = {
            ...
            {"cutoutenergy", 1, NULL, 0},
            {"cutoutwidth", 1, NULL, 0},
            {"ncarriers", 1, NULL, 'n'},
            {"simulation", 1, NULL, 'I'},
            {"relaxation", 1, NULL, 'R'},
            {"nreruns", 1, NULL, 'x'},
        ...
        c = getopt_long (argc, argv,
                         "hVqf:mi:Pt:F:T:l:X:Y:Z:N:p:a:n:I:R:x:B:o:y:c:",
        ...
        case 'q':              /* Don't say anything..  */
            ...
            if (update_arg
                ((void *) &(args_info->quiet_flag), 0,
                 &(args_info->quiet_given), &(local_args_info.quiet_given),
        ...
        case 'f':              /* Location of a configuration file for the simulation..  */
            ...
            if (update_arg ((void *) &(args_info->conf_file_arg),
                            &(args_info->conf_file_orig),
                            &(args_info->conf_file_given),
                            &(local_args_info.conf_file_given), optarg, 0, 0,
                            ARG_STRING, check_ambiguity, override, 0, 0,
                            "conf_file", 'f', additional_error))
                goto failure;
        ...
        case 'm':              /* Estimates the used memory for the specified parameter set. Print's the information and exits immediately.  */
            ...
            if (update_arg
                ((void *) &(args_info->memreq_flag), 0,
                 &(args_info->memreq_given), &(local_args_info.memreq_given),
                 optarg, 0, 0, ARG_FLAG, check_ambiguity, override, 1, 0,
                 "memreq", 'm', additional_error))
                goto failure;
        ...
        case 'i':              /* The number of runs to average over..  */
            ...
            if (update_arg ((void *) &(args_info->nruns_arg),
                            ...
                            &(local_args_info.nruns_given), optarg, 0, "1",
                            ARG_INT, check_ambiguity, override, 0, 0, "nruns",
                            'i', additional_error))
                goto failure;
        ...
        case 'P':              /* If the runs given with the --nruns option should be executed using mutliple cores and parallelization. This suppresses any progress output of the runs but will be very fast on multicore systems..  */
            ...
            if (update_arg
                ((void *) &(args_info->parallel_flag), 0,
                 &(args_info->parallel_given),
        ...
        case 't':              /* The number of threads to use during parallel computing. 0 means all there are..  */
            ...
            if (update_arg ((void *) &(args_info->nthreads_arg),
                            &(args_info->nthreads_orig),
                            &(args_info->nthreads_given),
                            &(local_args_info.nthreads_given), optarg, 0, "0",
                            ARG_INT, check_ambiguity, override, 0, 0,
                            "nthreads", 't', additional_error))
                goto failure;
        ...
        case 'F':              /* The electric field strength in z-direction..  */
            ...
            if (update_arg ((void *) &(args_info->field_arg),
                            ...
                            &(local_args_info.field_given), optarg, 0, "0.3",
                            ARG_FLOAT, check_ambiguity, override, 0, 0, "field",
                            'F', additional_error))
                goto failure;
        ...
        case 'T':              /* The temperature of the simulation..  */
            ...
            if (update_arg ((void *) &(args_info->temperature_arg),
                            &(args_info->temperature_orig),
                            &(args_info->temperature_given),
                            &(local_args_info.temperature_given), optarg, 0,
                            "0.3", ARG_FLOAT, check_ambiguity, override, 0, 0,
                            "temperature", 'T', additional_error))
                goto failure;
        ...
        case 'l':              /* This parameter specifies the length of the (cubic) sample. If it parameter is set, the options X,Y,Z are ignored!.  */
            ...
            if (update_arg ((void *) &(args_info->length_arg),
                            &(args_info->length_orig),
                            &(args_info->length_given),
                            &(local_args_info.length_given), optarg, 0, 0,
                            ARG_INT, check_ambiguity, override, 0, 0, "length",
                            'l', additional_error))
                goto failure;
        ...
        case 'X':              /* The x-length of the sample. Right now, only cubic samples should be used, so rather use the parameter --length..  */
            ...
            if (update_arg ((void *) &(args_info->X_arg),
                            ...
                            &(local_args_info.X_given), optarg, 0, "50",
                            ARG_INT, check_ambiguity, override, 0, 0, "X", 'X',
                            additional_error))
                goto failure;
        ...
        case 'Y':              /* The y-length of the sample. Right now, only cubic samples should be used, so rather use the parameter --length..  */
            ...
            if (update_arg ((void *) &(args_info->Y_arg),
                            ...
                            &(local_args_info.Y_given), optarg, 0, "50",
                            ARG_INT, check_ambiguity, override, 0, 0, "Y", 'Y',
                            additional_error))
                goto failure;
        ...
        case 'Z':              /* The z-length of the sample. Right now, only cubic samples should be used, so rather use the parameter --length..  */
            ...
            if (update_arg ((void *) &(args_info->Z_arg),
                            ...
                            &(local_args_info.Z_given), optarg, 0, "50",
                            ARG_INT, check_ambiguity, override, 0, 0, "Z", 'Z',
                            additional_error))
                goto failure;
        ...
        case 'N':              /* The number of localized states. This value has to be bigger than --ncarriers. Deprecated! Scale the number os states using --length..  */
            ...
            if (update_arg ((void *) &(args_info->nsites_arg),
                            &(args_info->nsites_orig),
                            &(args_info->nsites_given),
                            &(local_args_info.nsites_given), optarg, 0,
                            "125000", ARG_INT, check_ambiguity, override, 0, 0,
                            "nsites", 'N', additional_error))
                goto failure;

            break;
        case 'p':              /* The exponent of the DOS g(x) = exp(-(x)^p).  */


            if (update_arg ((void *) &(args_info->exponent_arg),
                            &(args_info->exponent_orig),
                            &(args_info->exponent_given),
                            &(local_args_info.exponent_given), optarg, 0, "2.0",
                            ARG_FLOAT, check_ambiguity, override, 0, 0,
                            "exponent", 'p', additional_error))
                goto failure;
        ...
        case 'a':              /* Localization length of the sites, assumed equal for all of them..  */
            ...
            if (update_arg ((void *) &(args_info->llength_arg),
                            &(args_info->llength_orig),
                            &(args_info->llength_given),
                            &(local_args_info.llength_given), optarg, 0,
                            "0.215", ARG_FLOAT, check_ambiguity, override, 0, 0,
                            "llength", 'a', additional_error))
                goto failure;
        ...
        case 'n':              /* The number of charge carriers in the system..  */
            ...
            if (update_arg ((void *) &(args_info->ncarriers_arg),
                            &(args_info->ncarriers_orig),
                            &(args_info->ncarriers_given),
                            &(local_args_info.ncarriers_given), optarg, 0, "10",
                            ARG_INT, check_ambiguity, override, 0, 0,
                            "ncarriers", 'n', additional_error))
                goto failure;
        ...
        case 'I':              /* The number of hops during which statistics are collected..  */
            ...
            if (update_arg ((void *) &(args_info->simulation_arg),
                            &(args_info->simulation_orig),
                            &(args_info->simulation_given),
                            &(local_args_info.simulation_given), optarg, 0,
                            "1000000000", ARG_LONG, check_ambiguity, override,
                            0, 0, "simulation", 'I', additional_error))
                goto failure;
        ...
        case 'R':              /* The number of hops to relax..  */
            ...
            if (update_arg ((void *) &(args_info->relaxation_arg),
                            &(args_info->relaxation_orig),
                            &(args_info->relaxation_given),
                            &(local_args_info.relaxation_given), optarg, 0,
                            "100000000", ARG_LONG, check_ambiguity, override, 0,
                            0, "relaxation", 'R', additional_error))
                goto failure;

            break;
        case 'x':              /* How many times should the electron be placed at some random starting position?.  */


            if (update_arg ((void *) &(args_info->nreruns_arg),
                            &(args_info->nreruns_orig),
                            &(args_info->nreruns_given),
                            &(local_args_info.nreruns_given), optarg, 0, "1",
                            ARG_INT, check_ambiguity, override, 0, 0, "nreruns",
                            'x', additional_error))
                goto failure;

            break;
        case 'B':              /* The percolation threshold..  */


            if (update_arg ((void *) &(args_info->percolation_threshold_arg),
                            &(args_info->percolation_threshold_orig),
                            &(args_info->percolation_threshold_given),
                            &(local_args_info.percolation_threshold_given),
                            optarg, 0, "2.7", ARG_FLOAT, check_ambiguity,
                            override, 0, 0, "percolation_threshold", 'B',
                            additional_error))
                goto failure;
        ...
        case 'o':              /* The name of the output folder if one wants output files..  */
            ...
            if (update_arg ((void *) &(args_info->outputfolder_arg),
                            &(args_info->outputfolder_orig),
                            &(args_info->outputfolder_given),
                            &(local_args_info.outputfolder_given), optarg, 0, 0,
                            ARG_STRING, check_ambiguity, override, 0, 0,
                            "outputfolder", 'o', additional_error))
                goto failure;

            break;
        case 'y':              /* The name of the summary file to which one summary result line is then written..  */


            if (update_arg ((void *) &(args_info->summary_arg),
                            &(args_info->summary_orig),
                            &(args_info->summary_given),
                            &(local_args_info.summary_given), optarg, 0, 0,
                            ARG_STRING, check_ambiguity, override, 0, 0,
                            "summary", 'y', additional_error))
                goto failure;

            break;
        case 'c':              /* Specify a string that is appended to the line in the summary file for better overview over the simulated data..  */


            if (update_arg ((void *) &(args_info->comment_arg),
                            &(args_info->comment_orig),
                            &(args_info->comment_given),
                            &(local_args_info.comment_given), optarg, 0, 0,
                            ARG_STRING, check_ambiguity, override, 0, 0,
                            "comment", 'c', additional_error))
                goto failure;
        ...
        case 0:                /* Long option with no short option */
            ...
            if (strcmp (long_options[option_index].name, "rseed") == 0)
            {
                ...
                if (update_arg ((void *) &(args_info->rseed_arg),
                                &(args_info->rseed_orig),
                                &(args_info->rseed_given),
                                &(local_args_info.rseed_given), optarg, 0, 0,
                                ARG_LONG, check_ambiguity, override, 0, 0,
                                "rseed", '-', additional_error))
                    goto failure;

            }
            /*
             * Determines up to which distance sites should be neighbors..  
             */
            else if (strcmp (long_options[option_index].name, "rc") == 0)
            {


                if (update_arg ((void *) &(args_info->rc_arg),
                                &(args_info->rc_orig), &(args_info->rc_given),
                                &(local_args_info.rc_given), optarg, 0, "3",
                                ARG_FLOAT, check_ambiguity, override, 0, 0,
                                "rc", '-', additional_error))
                    goto failure;
            ...
            /*
             * Use a Gaussian DOS with std. dev. 1. g(x) = exp(-1/2*(x)^2).  
             */
            else if (strcmp (long_options[option_index].name, "gaussian") == 0)
            {
                ...
                if (update_arg
                    ((void *) &(args_info->gaussian_flag), 0,
                     &(args_info->gaussian_given),
            ...
            else if (strcmp (long_options[option_index].name, "lattice") == 0)
            {
                ...
                if (update_arg
                    ((void *) &(args_info->lattice_flag), 0,
                     &(args_info->lattice_given),
             ...
             * Remove softpairs..  
             */
            else if (strcmp (long_options[option_index].name, "removesoftpairs")
                     == 0)
            {


                if (update_arg
                    ((void *) &(args_info->removesoftpairs_flag), 0,
                     &(args_info->removesoftpairs_given),
                     &(local_args_info.removesoftpairs_given), optarg, 0, 0,
                     ARG_FLAG, check_ambiguity, override, 1, 0,
                     "removesoftpairs", '-', additional_error))
                    goto failure;
                      ...
                      "softpairthreshold") == 0)
            {
                ...
                if (update_arg ((void *) &(args_info->softpairthreshold_arg),
                                &(args_info->softpairthreshold_orig),
                                &(args_info->softpairthreshold_given),
                                &(local_args_info.softpairthreshold_given),
                                optarg, 0, "0.95", ARG_FLOAT, check_ambiguity,
                                override, 0, 0, "softpairthreshold", '-',
                                additional_error))
                    goto failure;
             ...
             */
            else if (strcmp (long_options[option_index].name, "cutoutenergy") ==
                     0)
            {


                if (update_arg ((void *) &(args_info->cutoutenergy_arg),
                                &(args_info->cutoutenergy_orig),
                                &(args_info->cutoutenergy_given),
                                &(local_args_info.cutoutenergy_given), optarg,
                                0, "0", ARG_FLOAT, check_ambiguity, override, 0,
                                0, "cutoutenergy", '-', additional_error))
                    goto failure;
             ...
             */
            else if (strcmp (long_options[option_index].name, "cutoutwidth") ==
                     0)
            {


                if (update_arg ((void *) &(args_info->cutoutwidth_arg),
                                &(args_info->cutoutwidth_orig),
                                &(args_info->cutoutwidth_given),
                                &(local_args_info.cutoutwidth_given), optarg, 0,
                                "0.5", ARG_FLOAT, check_ambiguity, override, 0,
                                0, "cutoutwidth", '-', additional_error))
                    goto failure;

            }
            /*
             * Instead of simulating n carriers, use a single carrier in a modified DOS (mean field approach).  
             */
            else if (strcmp (long_options[option_index].name, "meanfield") == 0)
            {


                if (update_arg
                    ((void *) &(args_info->meanfield_flag), 0,
                     &(args_info->meanfield_given),
                     &(local_args_info.meanfield_given), optarg, 0, 0, ARG_FLAG,
                     check_ambiguity, override, 1, 0, "meanfield", '-',
                     additional_error))
                    goto failure;
            ...
            else if (strcmp (long_options[option_index].name, "be") == 0)
            {
                ...
                if (update_arg
                    ((void *) &(args_info->be_flag), 0, &(args_info->be_given),
            ...
            /*
             * Max inner iterations after which the calculation is stopped. .  
             */
            else if (strcmp (long_options[option_index].name, "be_it") == 0)
            {
                ...
                if (update_arg ((void *) &(args_info->be_it_arg),
                                &(args_info->be_it_orig),
                                &(args_info->be_it_given),
                                &(local_args_info.be_it_given), optarg, 0,
                                "1000", ARG_LONG, check_ambiguity, override, 0,
                                0, "be_it", '-', additional_error))
                    goto failure;
            ...
            else if (strcmp (long_options[option_index].name, "be_oit") == 0)
            {
                ...
                if (update_arg ((void *) &(args_info->be_oit_arg),
                                &(args_info->be_oit_orig),
                                &(args_info->be_oit_given),
                                &(local_args_info.be_oit_given), optarg, 0, "1",
                                ARG_LONG, check_ambiguity, override, 0, 0,
                                "be_oit", '-', additional_error))
                    goto failure;
            ...
            else if (strcmp (long_options[option_index].name, "tol_abs") == 0)
            {
                ...
                if (update_arg ((void *) &(args_info->tol_abs_arg),
                                &(args_info->tol_abs_orig),
                                &(args_info->tol_abs_given),
                                &(local_args_info.tol_abs_given), optarg, 0,
                                "1e-8", ARG_FLOAT, check_ambiguity, override, 0,
                                0, "tol_abs", '-', additional_error))
                    goto failure;
            ...
            else if (strcmp (long_options[option_index].name, "tol_rel") == 0)
            {
                ...
                if (update_arg ((void *) &(args_info->tol_rel_arg),
                                &(args_info->tol_rel_orig),
                                &(args_info->tol_rel_given),
                                &(local_args_info.tol_rel_given), optarg, 0,
                                "1e-8", ARG_FLOAT, check_ambiguity, override, 0,
                                0, "tol_rel", '-', additional_error))
                    goto failure;
            ...
            else if (strcmp (long_options[option_index].name, "an") == 0)
            {
                ...
                if (update_arg
                    ((void *) &(args_info->an_flag), 0, &(args_info->an_given),
             ...
             */
            else if (strcmp (long_options[option_index].name, "transitions") ==
                     0)
            {


                if (update_arg
                    ((void *) &(args_info->transitions_flag), 0,
                     &(args_info->transitions_given),
                     &(local_args_info.transitions_given), optarg, 0, 0,
                     ARG_FLAG, check_ambiguity, override, 1, 0, "transitions",
                     '-', additional_error))
                    goto failure;
