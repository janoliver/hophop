 ...
 * gengetopt --conf-parser --set-version=1.6 --set-package=HOP --show-required -l -i options.ggo 
 * 
...
init_args_info (struct gengetopt_args_info *args_info)
{
    ...
    args_info->cutoutenergy_help = gengetopt_args_info_help[26];
    args_info->cutoutwidth_help = gengetopt_args_info_help[27];
    args_info->simulation_help = gengetopt_args_info_help[30];
    args_info->relaxation_help = gengetopt_args_info_help[31];
    args_info->nreruns_help = gengetopt_args_info_help[32];
    args_info->be_help = gengetopt_args_info_help[35];
    args_info->be_it_help = gengetopt_args_info_help[36];
    args_info->be_oit_help = gengetopt_args_info_help[37];
    args_info->tol_abs_help = gengetopt_args_info_help[38];
    args_info->tol_rel_help = gengetopt_args_info_help[39];
    args_info->an_help = gengetopt_args_info_help[42];
    args_info->percolation_threshold_help = gengetopt_args_info_help[43];
    args_info->outputfolder_help = gengetopt_args_info_help[45];
    args_info->transitions_help = gengetopt_args_info_help[46];
    args_info->summary_help = gengetopt_args_info_help[47];
    args_info->comment_help = gengetopt_args_info_help[48];
                         ...
                         const char *additional_error)
{
    ...
    while (1)
    {
        ...
        c = getopt_long (argc, argv,
                         "hVqf:mi:Pt:l:X:Y:Z:n:N:p:a:F:T:I:R:x:B:o:y:c:",
