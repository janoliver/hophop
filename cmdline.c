...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->be_help = gengetopt_args_info_help[37] ;
  args_info->be_it_help = gengetopt_args_info_help[38] ;
  args_info->be_oit_help = gengetopt_args_info_help[39] ;
  args_info->tol_abs_help = gengetopt_args_info_help[40] ;
  args_info->tol_rel_help = gengetopt_args_info_help[41] ;
  args_info->an_help = gengetopt_args_info_help[44] ;
  args_info->percolation_threshold_help = gengetopt_args_info_help[45] ;
  args_info->outputfolder_help = gengetopt_args_info_help[47] ;
  args_info->transitions_help = gengetopt_args_info_help[48] ;
  args_info->summary_help = gengetopt_args_info_help[49] ;
  args_info->comment_help = gengetopt_args_info_help[50] ;
