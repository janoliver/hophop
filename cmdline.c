/*
  ...
  /import/vtthomes/oelerich/bin/gengetopt --conf-parser -i options.ggo 
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->conf_file_help = gengetopt_args_info_help[26] ;
...
cmdline_parser_required2 (struct gengetopt_args_info *args_info, const char *prog_name, const char *additional_error)
{
  ...
  if (! args_info->ncarriers_given)
    {
      fprintf (stderr, "%s: '--ncarriers' ('-n') option required%s\n", prog_name, (additional_error ? additional_error : ""));
      error = 1;
    }
      ...
      switch (c)
        ...
        case 'n':	/* The number of charge carriers in the system..  */
          ...
          if (update_arg( (void *)&(args_info->ncarriers_arg), 
              ...
              &(local_args_info.ncarriers_given), optarg, 0, "1250", ARG_INT,
              check_ambiguity, override, 0, 0,
              "ncarriers", 'n',
              additional_error))
            goto failure;
