 ...
 * gengetopt --conf-parser --set-version=1.2.3 --set-package=HOP --show-required -l -i options.ggo 
 * 
...
init_args_info (struct gengetopt_args_info *args_info)
{
    ...
    args_info->ar_help = gengetopt_args_info_help[27];
                         ...
                         const char *additional_error)
{
    ...
    while (1)
    {
        ...
        c = getopt_long (argc, argv,
                         "hVqf:mi:Pl:X:Y:Z:n:N:p:a:F:T:I:R:B:o:y:c:",
        ...
        case 0:                /* Long option with no short option */
            ...
            else if (strcmp (long_options[option_index].name, "ar") == 0)
            {
                ...
                if (update_arg
                    ((void *) &(args_info->ar_flag), 0, &(args_info->ar_given),
