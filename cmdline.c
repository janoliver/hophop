 ...
 * gengetopt --conf-parser --set-version=1.2.2 --set-package=HOP --show-required -l -i options.ggo 
 * 
                         ...
                         const char *additional_error)
{
    ...
    while (1)
    {
        ...
        c = getopt_long (argc, argv,
                         "hVqf:mi:Pl:X:Y:Z:n:N:s:p:a:F:T:I:R:B:o:y:c:",
        ...
        case 's':              /* The width of the DOS specified with --exponent..  */
            ...
            if (update_arg ((void *) &(args_info->sigma_arg),
                            ...
                            &(local_args_info.sigma_given), optarg, 0, "1.0",
                            ARG_FLOAT, check_ambiguity, override, 0, 0, "sigma",
                            's', additional_error))
                goto failure;
        ...
        case 0:                /* Long option with no short option */
            ...
            else if (strcmp (long_options[option_index].name, "be_it") == 0)
            {
                ...
                if (update_arg ((void *) &(args_info->be_it_arg),
                                ...
                                &(local_args_info.be_it_given), optarg, 0, "0",
                                ARG_LONG, check_ambiguity, override, 0, 0,
                                "be_it", '-', additional_error))
                    goto failure;
