...
void clear_given (struct gengetopt_args_info *args_info)
{
  ...
  args_info->addtoenergy_given = 0 ;
  args_info->addtonumber_given = 0 ;
...
void clear_args (struct gengetopt_args_info *args_info)
{
  ...
  args_info->addtoenergy_arg = 0;
  args_info->addtoenergy_orig = NULL;
  args_info->addtonumber_arg = -1000;
  args_info->addtonumber_orig = NULL;
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->addtoenergy_help = gengetopt_args_info_help[29] ;
  args_info->addtonumber_help = gengetopt_args_info_help[30] ;
  args_info->ncarriers_help = gengetopt_args_info_help[33] ;
  args_info->simulation_help = gengetopt_args_info_help[34] ;
  args_info->relaxation_help = gengetopt_args_info_help[35] ;
  args_info->nreruns_help = gengetopt_args_info_help[36] ;
  args_info->be_help = gengetopt_args_info_help[39] ;
  args_info->be_it_help = gengetopt_args_info_help[40] ;
  args_info->be_oit_help = gengetopt_args_info_help[41] ;
  args_info->tol_abs_help = gengetopt_args_info_help[42] ;
  args_info->tol_rel_help = gengetopt_args_info_help[43] ;
  args_info->an_help = gengetopt_args_info_help[46] ;
  args_info->percolation_threshold_help = gengetopt_args_info_help[47] ;
  args_info->outputfolder_help = gengetopt_args_info_help[49] ;
  args_info->transitions_help = gengetopt_args_info_help[50] ;
  args_info->summary_help = gengetopt_args_info_help[51] ;
  args_info->comment_help = gengetopt_args_info_help[52] ;
...
cmdline_parser_release (struct gengetopt_args_info *args_info)
{
  ...
  free_string_field (&(args_info->addtoenergy_orig));
  free_string_field (&(args_info->addtonumber_orig));
...
cmdline_parser_dump(FILE *outfile, struct gengetopt_args_info *args_info)
{
  ...
  if (args_info->cutoutenergy_given)
    write_into_file(outfile, "cutoutenergy", args_info->cutoutenergy_orig, 0);
  if (args_info->cutoutwidth_given)
    write_into_file(outfile, "cutoutwidth", args_info->cutoutwidth_orig, 0);
  if (args_info->addtoenergy_given)
    write_into_file(outfile, "addtoenergy", args_info->addtoenergy_orig, 0);
  if (args_info->addtonumber_given)
    write_into_file(outfile, "addtonumber", args_info->addtonumber_orig, 0);
  ...
  while (1)
    {
      ...
      static struct option long_options[] = {
        ...
        { "addtoenergy",	1, NULL, 0 },
        { "addtonumber",	1, NULL, 0 },
        { "ncarriers",	1, NULL, 'n' },
        { "simulation",	1, NULL, 'I' },
        { "relaxation",	1, NULL, 'R' },
        { "nreruns",	1, NULL, 'x' },
      ...
      c = getopt_long (argc, argv, "hVqf:mi:Pt:F:T:l:X:Y:Z:N:p:a:n:I:R:x:B:o:y:c:", long_options, &option_index);
      ...
      switch (c)
        ...
        case 'x':	/* How many times should the electron be placed at some random starting position?.  */
          ...
          if (update_arg( (void *)&(args_info->nreruns_arg), 
               &(args_info->nreruns_orig), &(args_info->nreruns_given),
              &(local_args_info.nreruns_given), optarg, 0, "1", ARG_INT,
              check_ambiguity, override, 0, 0,
              "nreruns", 'x',
              additional_error))
            goto failure;
        ...
        case 'B':	/* The percolation threshold..  */
          ...
          if (update_arg( (void *)&(args_info->percolation_threshold_arg), 
               &(args_info->percolation_threshold_orig), &(args_info->percolation_threshold_given),
              &(local_args_info.percolation_threshold_given), optarg, 0, "2.7", ARG_FLOAT,
              check_ambiguity, override, 0, 0,
              "percolation_threshold", 'B',
              additional_error))
            goto failure;
        ...
        case 0:	/* Long option with no short option */
          ...
          else if (strcmp (long_options[option_index].name, "cutoutenergy") == 0)
          {
            ...
            if (update_arg( (void *)&(args_info->cutoutenergy_arg), 
                 &(args_info->cutoutenergy_orig), &(args_info->cutoutenergy_given),
                &(local_args_info.cutoutenergy_given), optarg, 0, "0", ARG_FLOAT,
                check_ambiguity, override, 0, 0,
                "cutoutenergy", '-',
                additional_error))
              goto failure;
          ...
          else if (strcmp (long_options[option_index].name, "cutoutwidth") == 0)
          {
            ...
            if (update_arg( (void *)&(args_info->cutoutwidth_arg), 
                 &(args_info->cutoutwidth_orig), &(args_info->cutoutwidth_given),
                &(local_args_info.cutoutwidth_given), optarg, 0, "0.5", ARG_FLOAT,
                check_ambiguity, override, 0, 0,
                "cutoutwidth", '-',
                additional_error))
              goto failure;
          ...
          /* States around this energy will be add or removed out of the DOS.  */
          else if (strcmp (long_options[option_index].name, "addtoenergy") == 0)
          {
          
          
            if (update_arg( (void *)&(args_info->addtoenergy_arg), 
                 &(args_info->addtoenergy_orig), &(args_info->addtoenergy_given),
                &(local_args_info.addtoenergy_given), optarg, 0, "0", ARG_FLOAT,
                check_ambiguity, override, 0, 0,
                "addtoenergy", '-',
                additional_error))
              goto failure;
          ...
          /* This amount of sites will be added/removed (+/-).  */
          else if (strcmp (long_options[option_index].name, "addtonumber") == 0)
          {
          
          
            if (update_arg( (void *)&(args_info->addtonumber_arg), 
                 &(args_info->addtonumber_orig), &(args_info->addtonumber_given),
                &(local_args_info.addtonumber_given), optarg, 0, "-1000", ARG_INT,
                check_ambiguity, override, 0, 0,
                "addtonumber", '-',
                additional_error))
              goto failure;
          ...
          else if (strcmp (long_options[option_index].name, "be_it") == 0)
          {
            ...
            if (update_arg( (void *)&(args_info->be_it_arg), 
                ...
                &(local_args_info.be_it_given), optarg, 0, "1000", ARG_LONG,
                check_ambiguity, override, 0, 0,
                "be_it", '-',
                additional_error))
              goto failure;
