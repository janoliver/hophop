/*
  ...
  /usr/bin/gengetopt --conf-parser --show-required -l --set-version=2.4 --set-package=HOP -i /home/oelerich/Workspace/Physics/Hopping/HopHop/src/cli/options.ggo --output-dir=/home/oelerich/Workspace/Physics/Hopping/HopHop/src/cli/ 
...
void clear_given (struct gengetopt_args_info *args_info)
{
  ...
  args_info->many_given = 0 ;
  args_info->be_given = 0 ;
  args_info->mgmres_given = 0 ;
...
void clear_args (struct gengetopt_args_info *args_info)
{
  ...
  args_info->many_flag = 0;
  args_info->be_flag = 0;
  args_info->mgmres_flag = 0;
  args_info->be_it_arg = 300;
  args_info->be_it_orig = NULL;
  args_info->be_oit_arg = 10;
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->ncarriers_help = gengetopt_args_info_help[20] ;
  args_info->rc_help = gengetopt_args_info_help[21] ;
  args_info->exponent_help = gengetopt_args_info_help[22] ;
  args_info->llength_help = gengetopt_args_info_help[23] ;
  args_info->gaussian_help = gengetopt_args_info_help[24] ;
  args_info->lattice_help = gengetopt_args_info_help[25] ;
  args_info->removesoftpairs_help = gengetopt_args_info_help[26] ;
  args_info->softpairthreshold_help = gengetopt_args_info_help[27] ;
  args_info->cutoutenergy_help = gengetopt_args_info_help[28] ;
  args_info->cutoutwidth_help = gengetopt_args_info_help[29] ;
  ...
  args_info->many_help = gengetopt_args_info_help[35] ;
  args_info->be_help = gengetopt_args_info_help[38] ;
  args_info->mgmres_help = gengetopt_args_info_help[39] ;
...
cmdline_parser_dump(FILE *outfile, struct gengetopt_args_info *args_info)
{
  ...
  if (args_info->many_given)
    write_into_file(outfile, "many", 0, 0 );
  if (args_info->be_given)
    write_into_file(outfile, "be", 0, 0 );
  if (args_info->mgmres_given)
    write_into_file(outfile, "mgmres", 0, 0 );
  ...
  while (1)
    {
      ...
      c = getopt_long (argc, argv, "hVqf:mi:Pt:F:T:l:X:Y:Z:N:n:p:a:I:R:x:B:o:y:c:", long_options, &option_index);
      ...
      switch (c)
        ...
        case 'F':	/* The electric field strength in z-direction..  */
          ...
          if (update_arg( (void *)&(args_info->field_arg), 
              ...
              &(local_args_info.field_given), optarg, 0, "0.01", ARG_FLOAT,
              check_ambiguity, override, 0, 0,
              "field", 'F',
              additional_error))
            goto failure;
        ...
        case 'n':	/* The number of charge carriers in the system..  */
          ...
          if (update_arg( (void *)&(args_info->ncarriers_arg), 
              ...
              &(local_args_info.ncarriers_given), optarg, 0, "1", ARG_INT,
              check_ambiguity, override, 0, 0,
              "ncarriers", 'n',
              additional_error))
            goto failure;
        ...
        case 0:	/* Long option with no short option */
          ...
          /* Instead of using the mean field approach, simulate multiple charge carriers. (slow!!!).  */
          else if (strcmp (long_options[option_index].name, "many") == 0)
          {
          
          
            if (update_arg((void *)&(args_info->many_flag), 0, &(args_info->many_given),
                &(local_args_info.many_given), optarg, 0, 0, ARG_FLAG,
                check_ambiguity, override, 1, 0, "many", '-',
                additional_error))
              goto failure;
          ...
          /* Force use of mgmres instead of lis.  */
          else if (strcmp (long_options[option_index].name, "mgmres") == 0)
          {
          
          
            if (update_arg((void *)&(args_info->mgmres_flag), 0, &(args_info->mgmres_given),
                &(local_args_info.mgmres_given), optarg, 0, 0, ARG_FLAG,
                check_ambiguity, override, 1, 0, "mgmres", '-',
                additional_error))
              goto failure;
          ...
          else if (strcmp (long_options[option_index].name, "be_it") == 0)
          {
            ...
            if (update_arg( (void *)&(args_info->be_it_arg), 
                ...
                &(local_args_info.be_it_given), optarg, 0, "300", ARG_LONG,
                check_ambiguity, override, 0, 0,
                "be_it", '-',
                additional_error))
              goto failure;
          ...
          else if (strcmp (long_options[option_index].name, "be_oit") == 0)
          {
            ...
            if (update_arg( (void *)&(args_info->be_oit_arg), 
                ...
                &(local_args_info.be_oit_given), optarg, 0, "10", ARG_LONG,
                check_ambiguity, override, 0, 0,
                "be_oit", '-',
                additional_error))
              goto failure;
